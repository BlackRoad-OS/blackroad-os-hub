...
const APPS = [
  { id: "repos", name: "Repo Browser", desc: "Browse all 130+ repositories with search, filtering, and live data", icon: "📂", color: "#FF1D6C", subdomain: "repos.blackroad.io", href: "/repos" },
